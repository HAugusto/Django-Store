...
urlpatterns = [
    ...
    path('armazens/', views.ClientPageView.ClientPage, name='tabela-armazem'),
    path('filiais/', views.ClientPageView.ClientPage, name='tabela-filial'),
    path('clientes/', views.ClientPageView.ClientPage, name='tabela-cliente'),
    path('fornecedores/', views.ClientPageView.ClientPage, name='tabela-fornecedor'),
    path('componentes/', views.ClientPageView.ClientPage, name='tabela-componente'),
    path('produtos/', views.ClientPageView.ClientPage, name='tabela-produto'),
