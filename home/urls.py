...
urlpatterns = [
    ...
    # READ - FUNCIONANDO
    path('ler/', views.ReadPageView.ReadPage, name='tabelas'),
    path('armazens/', views.ReadPageView.HomePage, name='tabela-armazem'),
    ...
    path('produtos/', views.ReadPageView.ProductsPage, name='tabela-produto'),
    ...
    path('produto/<int:id>/', views.UpdatePageView.ProductIDPage, name='editar-produto'), # REVISAR
    ...
    # DELETE - FUNCIONANDO
    path('armazem/<int:id>/remover/', views.DeletePageView.StoragePage, name='remover-armazem'),
